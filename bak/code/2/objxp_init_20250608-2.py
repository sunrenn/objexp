...
def ox(
    ...
    result_content_text_md += "_"*winww+"\n"
    result_content_text_md += "\nOBJ'S TYPE:\n\n"
    ...
    result_content_text = result_content_text_md
    ...
    for iii in dirjson:
        ...
        result_content_text += "\n\033[1;40;34m "+content_title_typename[8:-2].upper()+" \033[0m\033[40;34mmembers: \033[0m\n"
        ...
        result_content_text_md += content_objs_list + "\n"
